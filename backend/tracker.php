...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        $sql = "INSERT INTO tracker (ID_TRACKER, KALORI_MASUK, KALORI_KELUAR, TANGGAL) 
        VALUES (:id_tracker, :kalori_masuk, :kalori_keluar, TO_TIMESTAMP(:tanggal, 'YYYY-MM-DD HH24:MI:SS'))";
